...
#Loading Data Today's second dataset comes directly from the ICPSR and is an excel format. If we want to we can use a command from the xlsx package(loaded above) to input the data directly.
...
We will use the dplyr package to tidy the data.
...
Clearly not recoding for NA will be a major problem. We'll talk about how to handle missing data later.
